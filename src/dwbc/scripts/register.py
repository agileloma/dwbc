...
# dwbc/.venv/lib/python3.13/site-packages/mjlab/tasks/registry.py
...
from mjlab.rl import B2Z1RslRlBaseRunnerCfg

@dataclass
class _TaskCfg:
  env_cfg: ManagerBasedRlEnvCfg
  play_env_cfg: ManagerBasedRlEnvCfg
  rl_cfg: B2Z1RslRlBaseRunnerCfg
...
def load_rl_cfg(task_name: str) -> B2Z1RslRlBaseRunnerCfg:
